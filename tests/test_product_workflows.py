...
from pixweave.backend import LocalBackend
from pixweave.beta_launch import (
    BetaLaunchReadinessError,
    evaluate_beta_launch_package,
    evaluate_beta_launch_package_file,
)
from pixweave.brandkit import BrandKitError, build_campaign_manifest, validate_brand_kit, write_json
from pixweave.campaign_render import (
    CampaignRenderError,
    CampaignRenderVerificationError,
    render_campaign_bundle,
    verify_campaign_render_bundle,
)
from pixweave.campaign_review import CampaignReviewError, record_campaign_review
from pixweave.cli import main as cli_main
from pixweave.config import load_config
from pixweave.feedback import FeedbackError, capture_feedback, triage_feedback
from pixweave.product_shot import ProductShotWorkflowError, build_product_shot_manifest
from pixweave.prompt_pack import PromptPackError, build_prompt_manifest
from pixweave.unit_economics import UnitEconomicsError, calculate_scenarios
from pixweave.visual_qa import VisualQAScorecardError, build_scorecard
...
""".strip()
    ...
    def test_campaign_render_publication_failure_leaves_no_partial_output(self) -> None:
        ...
        with patch("pixweave.campaign_render.os.replace", side_effect=OSError("simulated publish failure")):
    ...
    def test_campaign_review_is_deterministic_and_leaves_no_partial_output(self) -> None:
        ...
        with patch("pixweave.brandkit.os.replace", side_effect=OSError("simulated review write failure")):
    ...
    def test_json_artifact_write_preserves_existing_file_when_replace_fails(self) -> None:
        ...
        with patch("pixweave.brandkit.os.replace", side_effect=OSError("simulated interruption")):
